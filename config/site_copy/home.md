...
> RetaBase documents what the literature and public registries report — it is **not medical advice** and not a guide to obtaining anything. We are explicitly against using these substances without a qualified clinician; many interact with prescription medicines or have risks that are not yet characterised. An absence of reported harms here is not evidence of safety. See **Methods** for the full statement and how regulatory status is sourced.
